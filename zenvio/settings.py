"""
Django settings for zenvio project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-zenvio-dev-key-change-in-production')
...
WSGI_APPLICATION = 'zenvio.wsgi.application'
